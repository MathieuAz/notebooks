...
import { addCellToNotebookContent, removeCellFromNotebookById, changeCellType, textToNotebookContent, notebookContentToText } from '../notebookContent';
...
let StarboardNotebook = class StarboardNotebook extends LitElement {
    constructor() {
        super(...arguments);
        this.notebookContent = { frontMatter: "", cells: [] };
        this.cellElements = [];
    }
    createRenderRoot() {
        return this;
    ...
    connectedCallback() {
        ...
        this.notebookContent = window.initialNotebookContent ? textToNotebookContent(window.initialNotebookContent) : { frontMatter: "", cells: [] };
    ...
    performUpdate() {
        ...
        for (let i = 0; i < this.notebookContent.cells.length; i++) {
            ...
            const newCellElement = new CellElement(cellProxy, this.runtime, (event) => {
...
], StarboardNotebook.prototype, "cellsParentElement", void 0);
__decorate([
    debounce(200)
], StarboardNotebook.prototype, "onCellChanged", null);
StarboardNotebook = __decorate([
    customElement('starboard-notebook')
], StarboardNotebook);
export { StarboardNotebook };
